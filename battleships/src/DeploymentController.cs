...
static class DeploymentController
{
	...
	public static void HandleDeploymentInput()
	{
		...
		if (SwinGame.MouseClicked(MouseButton.LeftButton)) {
			...
			if (GameController.HumanPlayer.ReadyToDeploy & UtilityFunctions.IsMouseInRectangle(PlayButtonLeft, TopButtonsTop, PlayButtonWidth, TopButtonsHeight)) {
				...
				//GameController.SwitchState(GameController.GameState.ViewingMainMenu); BUGS THAT NEEDED FIX !!
			}
		}
	}
    ...
    public static void DrawDeployment()
    {
        ...
        //SwinGame.DrawText("Return To Menu", ConsoleColor.Gray, GameResources.GameFont("Menu"), LeftRightButtonLeft, TopReturnToMenu);
